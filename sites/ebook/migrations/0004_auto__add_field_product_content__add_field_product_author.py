...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('ebook_product', 'content')

        # Deleting field 'Product.author'
        db.delete_column('ebook_product', 'author')
    ...
    models = {
        ...
        'ebook.product': {
            ...
            'content': ('django.db.models.fields.TextField', [], {'null':'True','blank':'False'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'focus_date': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
