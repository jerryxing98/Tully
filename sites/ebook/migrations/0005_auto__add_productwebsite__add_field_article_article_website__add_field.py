...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductWebsite'
        db.create_table('ebook_productwebsite', (
        ...
        db.send_create_signal('ebook', ['ProductWebsite'])

        # Adding field 'Article.article_website'
        db.add_column('ebook_article', 'article_website',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['ebook.ProductWebsite']),
                      keep_default=False)

        # Adding field 'Article.url'
        db.add_column('ebook_article', 'url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Article.checker_runtime'
        db.add_column('ebook_article', 'checker_runtime',
    ...
    def backwards(self, orm):
        # Deleting model 'ProductWebsite'
        db.delete_table('ebook_productwebsite')

        # Deleting field 'Article.article_website'
        db.delete_column('ebook_article', 'article_website_id')

        # Deleting field 'Article.url'
        db.delete_column('ebook_article', 'url')

        # Deleting field 'Article.checker_runtime'
        db.delete_column('ebook_article', 'checker_runtime_id')
